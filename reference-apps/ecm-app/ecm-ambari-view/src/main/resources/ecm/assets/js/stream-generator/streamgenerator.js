...
function ApplicationModel() {
  ...
  self.streamGenerator = ko.observable(new StreamGeneratorModel());
...
function StreamGeneratorModel(stompClient) {
	  ...
	  self.routeDirectory = ko.observable("/Users/gvetticaden/Dropbox/Hortonworks/Development/Git/sedev/coe/reference-apps/hdp-ref-apps-web/src/main/resources/routes/midwest");
