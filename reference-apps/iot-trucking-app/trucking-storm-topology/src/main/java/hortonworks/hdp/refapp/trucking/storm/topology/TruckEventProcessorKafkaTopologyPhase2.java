...
public class TruckEventProcessorKafkaTopologyPhase2 extends BaseTruckEventTopology {
	
	private static final Logger LOG = LoggerFactory.getLogger(TruckEventProcessorKafkaTopologyPhase2.class);
	
	
	public TruckEventProcessorKafkaTopologyPhase2(String configFileLocation) throws Exception {
		
		super(configFileLocation);			
	}
	
	public TruckEventProcessorKafkaTopologyPhase2(Properties prop) throws Exception {
	...
	public void configureHBaseBolt(TopologyBuilder builder) {
		...
		builder.setBolt("HBase-Sink", hbaseBolt, 2 ).shuffleGrouping("Truck-Events-Stream");
	}
	...
	public static void main(String[] args) throws Exception {
		...
		TruckEventProcessorKafkaTopologyPhase2 truckTopology = new TruckEventProcessorKafkaTopologyPhase2(configFileLocation);
