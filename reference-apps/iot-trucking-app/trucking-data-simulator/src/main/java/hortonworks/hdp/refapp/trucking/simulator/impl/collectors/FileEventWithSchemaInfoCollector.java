...
public class FileEventWithSchemaInfoCollector extends BaseTruckEventCollector {
	...
	private static final int TRUCK_GEO_EVENT_SCHEMA_VERSION = 1;
	
	private static final String TRUCK_SPEED_EVENTS_SCHEMA_NAME = "truck_speed_events_avro";
	private static final int TRUCK_SPEED_EVENT_SCHEMA_VERSION = 1;
	...
	private void sendTruckEventToFile(MobileEyeEvent mee) {
		...
		String eventToPassWithSchema = addSchemaInfo(SCHEMA_GROUP_NAME, TRUCK_EVENTS_SCHEMA_NAME, TRUCK_GEO_EVENT_SCHEMA_VERSION, eventToPass);
	...
	private void sendTruckSpeedEventToFile(MobileEyeEvent mee) {
		...
		String eventToPassWithSchema = addSchemaInfo(SCHEMA_GROUP_NAME, TRUCK_SPEED_EVENTS_SCHEMA_NAME, TRUCK_SPEED_EVENT_SCHEMA_VERSION, eventToPass);
